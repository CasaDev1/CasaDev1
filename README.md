...
- Developed a local dashboard for a thermal energy storage system using Python Flask and Dash. [WKO Dashboard](https://github.com/CasaDev1/Proefopstelling-Warmte-Koude-Opslag)
